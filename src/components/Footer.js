    ...
    <footer>
      <div className="container mx-auto mb-10 max-w-screen-xl">
        <div className='flex items-start'>
          ...
          <Link to="/contact"><button className="text-sm sm:text-base py-2 mr-4 rounded-lg flex items-center transition-all ease-out duration-300 hover:bg-slate-100 hover:scale-105 active:scale-100 cursor-pointer">Contact</button></Link>
        </div>
