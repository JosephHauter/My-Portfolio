...
import WorkCard from './pages/Work';
...
function App() {
  ...
  <div class="container mx-auto mb-10 max-w-screen-xl" id="projects">
    <h1 className='text-3xl sm:text-6xl lg:text-6xl xl:text-8xl p-1 sm:p-2 w-4/5 sm:w-full lg:w-4/5 transform translate-x-0 translate-y-0 opacity-100'>Projects.</h1>
